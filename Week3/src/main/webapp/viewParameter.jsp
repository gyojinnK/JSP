...
<body>
	...
	<h4 style="color:red">request.getParameterValues() 메소드 사용</h4>
	<%
	...
	<h4 style="color:red">request.getParameterNames() 메소드 사용</h4>
	<%
	...
	<h4 style="color:red">request.getParameterMap() 메소드 사용</h4>
	<%
